...
try{
  ...
  await page.goto(new URL('commons/sauna/',base).href);await page.getByRole('button',{name:/確認できた全件/}).click();await page.locator('.verified-list article').first().waitFor();await open();
