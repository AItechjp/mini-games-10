...
export const apps=[
  ...
  ...[['supermarkets','スーパー'],['saunas','サウナ'],['sento','銭湯'],['fishmongers','魚屋']].map(([id,name])=>directory('local-'+id,'岐阜・愛知の営業中'+name,'/commons/local/'+id+'/','.local-store','県・市町村・店名で絞り込み、登録営業時間と情報源を確認します。「要確認」も確認してください。')),
  directory('ramen','岐阜の営業中ラーメン','/commons/ramen/','[data-quality-result]','地域・店名で絞り込み、営業時間内・要確認・営業時間外を切り替えます。ラストオーダーも確認します。'),
  directory('sauna','全国の営業中サウナ','/commons/sauna/','[data-facility-id]','都道府県と営業状況を選びます。施設全体の営業時間とサウナの利用時間が異なる場合があります。'),
