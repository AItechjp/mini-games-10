...
const skipDirs = new Set(['.git', '.github', 'node_modules', 'tests', 'supabase', 'tools', 'scripts', 'test-output', 'test-results', 'playwright-report', '_site', 'vendor', 'commons-src', 'dist', 'src', 'source', 'backend', 'cloudflare', 'docs', 'roadmap']);
