...
const audit={date:'2026-09-14',scope:'現在のカタログに掲載された33アプリ。旧URL・アーカイブは互換性を維持。',publication:'検証・公開前',definition:'各アプリ100の改善・確認項目。共通40、用途別40、個別20。同じ実装を共用する項目を含み、3300種類の独立した新機能ではありません。未検証・未実装の項目を完了とは扱いません。',apps:[]};
