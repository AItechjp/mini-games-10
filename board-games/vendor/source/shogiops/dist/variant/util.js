...
export function pieceForcePromote(rules) {
    switch (rules) {
        case 'chushogi':
        case 'annanshogi':
            return () => false;
...
export function promotableOnDrop(rules) {
    switch (rules) {
        case 'kyotoshogi':
            return (piece) => promotableRoles(rules).includes(piece.role);
        default:
...
export function fullSquareSet(rules) {
    switch (rules) {
        case 'chushogi':
...
export function dimensions(rules) {
    switch (rules) {
        case 'chushogi':
...
function minishogiPromote(role) {
    switch (role) {
        case 'pawn':
            return 'tokin';
        case 'silver':
...
function minishogiUnpromote(role) {
    switch (role) {
        case 'tokin':
            return 'pawn';
        case 'promotedsilver':
...
function kyotoshogiPromote(role) {
    switch (role) {
        case 'rook':
            return 'pawn';
        case 'pawn':
...
function dobutsuUnpromote(role) {
    switch (role) {
        case 'tokin':
            return 'pawn';
        default:
