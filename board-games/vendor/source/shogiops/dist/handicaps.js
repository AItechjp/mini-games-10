...
export function findHandicaps(handicapOpt) {
...
export function findHandicap(handicapOpt) {
    const hs = findHandicaps(handicapOpt);
    return defined(hs) ? hs[0] : undefined;
}
export function isHandicap(handicapOpt) {
...
export const handicaps = [
    ...
    ...standardHandicaps.map((h) => {
        return Object.assign({ rules: 'standard' }, h);
    }),
    // minishogi
    {
        rules: 'minishogi',
    ...
    // checkshogi
    ...standardHandicaps.map((h) => {
        return Object.assign({ rules: 'checkshogi' }, h);
    }),
    // dobutsu
    {
        rules: 'dobutsu',
...
//# sourceMappingURL=handicaps.js.map