...
The current original application code is proprietary. Third-party license notices
remain in vendor/: Chess.js 1.4.0 (BSD-2-Clause), tsshogi 2.3.4 (MIT), and
Three.js 0.180.0 (MIT). The Shogi integration is implemented in shogi-adapter.mjs;
no shogiops code is used by the current build. Earlier releases retain their
original licensing; this change does not revoke licenses already granted.
