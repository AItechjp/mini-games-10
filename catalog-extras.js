(() => {
  ...
  const extras = [
    ...
    { n: 14, title: 'JAPANESE TYPE ATTACK', badge: 'NEW / TYPING', desc: online ? '表示された日本語を日本語IMEで入力。同じお題順で2人同時に20秒スコア勝負。' : '表示された日本語を日本語IMEでそのまま入力。CPM・正確率・ミスも記録する20秒勝負。', href: `typing.html?mode=${online ? 'online' : 'solo'}`, action: online ? '日本語タイピング対戦' : '日本語タイピング' },
